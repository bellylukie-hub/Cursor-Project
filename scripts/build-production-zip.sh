...
copy_item \
  ...
  custom-reports.js themes.js process-guide.js help-assistant.js internal-communication.js report-export.js i18n.js soft-delete.js bulk-actions.js database-tools.js favicon.svg images \
